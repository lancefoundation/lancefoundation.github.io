  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <p className="text-xl sm:text-2xl mb-8 opacity-90 max-w-2xl mx-auto slide-in-right">
          Join us in creating lasting impact through education, healthcare, and community development programs that transform communities worldwide.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button 
            asChild
            size="lg"
            className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold px-8 py-4 rounded-full transition-all duration-300 hover:scale-105 pulse-glow"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-16">
          <div className="text-center fade-in-up">
            <div className="text-3xl sm:text-4xl font-bold text-yellow-300 mb-2">50,000+</div>
            <div className="text-lg opacity-90">Lives Impacted</div>
          </div>
          <div className="text-center fade-in-up" style={{ animationDelay: '0.2s' }}>
            <div className="text-3xl sm:text-4xl font-bold text-yellow-300 mb-2">120+</div>
            <div className="text-lg opacity-90">Projects Completed</div>
          </div>
          <div className="text-center fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="text-3xl sm:text-4xl font-bold text-yellow-300 mb-2">25</div>
