        ...
        <div className="flex justify-between items-center h-18">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="relative">
              ...
              />
              <div className="absolute -top-1 -right-1 h-4 w-4 bg-gradient-to-r from-teal-500 to-green-500 rounded-full animate-pulse"></div>
            </div>
            <div className="flex flex-col">
              <div className="text-xl font-bold bg-gradient-to-r from-teal-600 to-green-600 bg-clip-text text-transparent">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Button asChild className="ml-6 bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-pulse">
